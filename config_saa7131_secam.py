...
sample_rate = 27000000 #35468950.0*1600.0/2048.0     # sample rate of BT8x8 PAL VBI
teletext_bitrate = 6937500.0 # bit rate of PAL teletext

line_start_range = [0, 15] # range covering start position of clock run-in, in samples

line_length = 1600           # length of raw lines in samples
line_trim = 1440             # ignore raw samples after this point
...
line_start_pre = [max(0, int(line_start - (bit_width * 15))), max(1, int(line_start - (bit_width * 2)))]
